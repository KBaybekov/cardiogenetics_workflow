...
def parse_cli_args():
    ...
    parser.add_argument('-tr', '--trimmomatic_opts', default='', type=str, help=arg_descriptions['trimmomatic_opts'])
    ...
    parser.add_argument('-vfd', '--variant_filters_deepvariant', default='', type=str, help=arg_descriptions['variant_filters_deepvariant'])
    parser.add_argument('-vff', '--variant_filters_freebayes', default='', type=str, help=arg_descriptions['variant_filters_freebayes'])
