...
def parse_cli_args():
    ...
    """
    parser = argparse.ArgumentParser(epilog="© Kirill Baybekov, 2025")

    description={
        'input_dir': 'Директория с файлами .tsv аннотации cravat',
        'output_dir': 'Директория для .xlsx файлов',
        'frequency_threshold': 'Максимальная частота встречаемости вариантов',
        'gene_panel': 'Генная панель, по которой необходимо провести фильтрацию'
    }
